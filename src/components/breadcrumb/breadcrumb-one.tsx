...
const BreadcrumbOne = ({
  title,
  subtitle,
  bg_img = '/assets/images/media/contact.webp',
  page,
  cls='',
  style_2 = false,
  shape
  ...
  const words = title.split(' ');
   ...
   // Extract the first, last, and middle words
            ...
            {!style_2 && (
              <div className="row align-items-center">
                <div className="col-lg-7">
                  <h1 className={`hero-heading text-white d-inline-block position-relative ${cls}`}>
                    {firstWord} <text className="text-style">{lastWord}</text> <img src={shape} alt="shape" />
                  </h1>
                </div>
