      ...
      <header className={`theme-main-menu menu-overlay menu-style-two sticky-menu ${sticky?'fixed':''}`}>
        <div className="gap-fix info-row">
          <div className="d-md-flex justify-content-between">
            <div className="greetings text-center"><span className="opacity-50">Hello!!</span> <span className="fw-500">Welcome to Minatas Resources.</span></div>
            <ul className="style-none d-none d-md-flex contact-info">
              <li className="d-flex align-items-center">
                ...
                <a href="mailto:inquiries@minatasresources.com" className="fw-500">inquiries@minatasresources.com</a>
                </li>
              <li className="d-flex align-items-center">
                <img src="/assets/images/icon/icon_15.svg" alt="icon" className="lazy-img icon me-2" /> 
                <a href="tel:+260771873366" className="fw-500">+260771873366</a>
                </li>
            </ul>
          </div>
        </div>
